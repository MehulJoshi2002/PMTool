    ...
    <div className="min-h-screen bg-[#0E1015] flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Sign in to your ProductOS workspace</p>
        </div>
        ...
        <div className="bg-[#171923] rounded-2xl border border-white/[0.06] shadow-xl p-8">
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-bold py-2.5 rounded-lg transition shadow-lg shadow-blue-500/20 mt-4"
            >
