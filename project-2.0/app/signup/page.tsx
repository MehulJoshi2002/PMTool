    ...
    <div className="min-h-screen bg-slate-100 dark:bg-[#0E1015] flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-600 dark:text-gray-500 text-sm mt-1">Start building better products today</p>
        </div>
        ...
        <div className="bg-white dark:bg-[#171923] rounded-2xl border border-slate-200 dark:border-white/[0.06] shadow-xl p-8">
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-slate-500 dark:text-gray-400 uppercase tracking-wider pl-1">Full Name</label>
              <div className="relative">
                <User size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-gray-600" />
                <input
                  type="text"
                  value={name}
                  onChange={(e) => setName(e.target.value)}
                  placeholder="Jane Doe"
                  className="w-full bg-white dark:bg-black/20 border border-slate-200 dark:border-white/[0.08] text-slate-900 dark:text-white text-sm pl-10 pr-4 py-2.5 rounded-lg focus:outline-none focus:border-violet-500/50 transition placeholder-gray-700"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-slate-500 dark:text-gray-400 uppercase tracking-wider pl-1">Password</label>
              <div className="relative">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 bg-violet-600 hover:bg-violet-500 disabled:opacity-50 disabled:cursor-not-allowed text-slate-900 dark:text-white text-sm font-bold py-2.5 rounded-lg transition shadow-sm dark:shadow-lg shadow-violet-500/20 mt-4"
            >
