  ...
  return (
    <div className="flex flex-col space-y-2 mb-4">
      ...
      <div className="flex items-center space-x-2">
        <span className="text-xs text-gray-600 font-medium font-mono">1</span>
        <input
          type="range"
          min="1"
          max="5"
        ...
        />
        <span className="text-xs text-gray-600 font-medium font-mono">5</span>
      </div>
      
      <div className="flex justify-between text-[10px] text-gray-600 font-mono pt-0.5 px-4">
        <span>Low</span>
        <span>High</span>
      </div>
    </div>
